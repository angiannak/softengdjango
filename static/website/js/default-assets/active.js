(function($) {
  'use strict';
  var cinedo_window = $(window);

  // *******************************
  // :: 1.0 Preloader Active Code
  // *******************************

  cinedo_window.on('load', function() {
  ...
  if($.fn.imagesLoaded) {
    $('.cinedo-portfolio').imagesLoaded(function() {
      ...
      // init Isotope
      var $grid = $('.cinedo-portfolio').isotope({
  ...
  if($.fn.scrollUp) {
    cinedo_window.scrollUp({
      scrollSpeed: 2000,
      scrollText: '<i class="arrow_up"</i>'
    });
  }
  // :: 13.0 Sticky Active Code
  cinedo_window.on('scroll', function() {
    if(cinedo_window.scrollTop() > 40) {
